...
import './contact.scss';
import { motion } from 'framer-motion'; // Removed useInView import as it's not being used
...
const Contact = () => {
  const formRef = useRef(); // Renamed ref to formRef
    ...
    <motion.div className="contact" variants={variants} initial="initial" animate="animate">
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div className="item" variants={variants}>
          <h2>Mail</h2>
          <span>waleedelshafey800@gmail.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Address</h2>
          <span>Mansoura</span>
